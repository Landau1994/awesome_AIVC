...
url: https://doi.org/10.1016/j.cell.2026.01.012
tags:
  - paper
  - AIVC
  - self-driving-lab
...
## Quick Summary
> The authors present [[Cell 2026 LUMI-lab A foundation model-driven autonomous platform enabling discovery of ionizable lipid designs for mRNA delivery|LUMI-lab]], a fully autonomous self-driving laboratory that integrates a molecular foundation model with high-throughput robotics to discover novel [[ionizable lipids]] for [[mRNA delivery]]. By employing an iterative [[active learning]] workflow that balances exploration and exploitation, the system synthesized and screened over 1,700 lipid candidates, identifying [[brominated lipid tails]] as a potent structural motif. The top candidate, [[Cell 2026 LUMI-lab A foundation model-driven autonomous platform enabling discovery of ionizable lipid designs for mRNA delivery|LUMI-6]], demonstrated superior pulmonary transfection efficiency, achieving 20.3% gene editing efficacy in mouse lung epithelial cells.
...
- In vivo validation showed [[Cell 2026 LUMI-lab A foundation model-driven autonomous platform enabling discovery of ionizable lipid designs for mRNA delivery|LUMI-6]] outperforms clinically approved benchmarks ([[SM-102]] and [[MC3]]) in pulmonary gene editing.
